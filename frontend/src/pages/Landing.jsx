    ...
    <div className="min-h-screen font-sans">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden bg-bank-dark">
        ...
        <div className="relative z-10 flex flex-col items-center text-center gap-3 px-4 pt-20 sm:pt-24 md:pt-28">
          ...
          <div className="w-[min(80vw,720px)] max-w-[720px]">
            <svg viewBox="0 0 900 180" className="w-full h-auto" aria-hidden="true">
              <defs>
                <path id="welcome-arc" d="M60 140 Q450 125 840 140" />
              </defs>
              <text
                fill="#8fdb46"
                fontSize="72"
                ...
                fontStyle="italic"
                letterSpacing="6"
                style={{ filter: 'drop-shadow(0 4px 16px rgba(143,219,70,0.4))' }}
              >
